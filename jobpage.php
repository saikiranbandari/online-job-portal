...
<div class="topnav">
				...
				<ul><li style="float:right"><a href="signup.php">Register</a> </li>
				 <li style="float:right"><a class="active" href="login.php">login</a></li>
</ul>
				
   </div>
   <p align="center"> you are not registered so please register<p></br>
<h1 align="center" font="Karma">our jobseekers</h1>
</body>
</html>
